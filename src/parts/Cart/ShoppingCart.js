...
function ShoppingCart() {
      ...
      <div class="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="1">
        <div class="px-4 flex-none">
          <div class="" style={{ width: 90, height: 90 }}>
            <img src="/chair-1.png" alt="chair-1" class="object-cover rounded-xl w-full h-full" />
          </div>
        </div>
  ...
  <!-- START: ROW 2 --> */}
      <div class="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="2">
        <div class="px-4 flex-none">
          <div class="" style={{ width: 90, height: 90 }}>
            <img src="/chair-2.png" alt="chair-2" class="object-cover rounded-xl w-full h-full" />
          </div>
        </div>
        <div class="px-4 w-auto flex-1 md:w-5/12">
          <div class="">
      ...
      <div class="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="3">
        <div class="px-4 flex-none">
          <div class="" style={{ width: 90, height: 90 }}>
            <img src="/chair-3.png" alt="chair-3" class="object-cover rounded-xl w-full h-full" />
          </div>
        </div>
        <div class="px-4 w-auto flex-1 md:w-5/12">
          <div class="">
