      ...
      <div class="flex flex-wrap my-4 md:my-12">
        ...
        <div class="flex-1">
          <div class="slider">
            <div class="thumbnail">
              <div class="px-2">
                <div class="item selected" data-img="/showcase-1.front.jpg">
                  <img src="/showcase-1.front.jpg" alt="front" class="object-cover w-full h-full rounded-lg" />
                </div>
              </div>
              <div class="px-2">
                <div class="item" data-img="/showcase-1.back.jpg">
                  <img src="/showcase-1.back.jpg" alt="back" class="object-cover w-full h-full rounded-lg" />
                </div>
              </div>
              <div class="px-2">
                <div class="item" data-img="/showcase-1.rear.jpg">
                  <img src="/showcase-1.rear.jpg" alt="rear" class="object-cover w-full h-full rounded-lg" />
                </div>
              </div>
              <div class="px-2">
                <div class="item" data-img="/showcase-1.side.jpg">
                  <img src="/showcase-1.side.jpg" alt="side" class="object-cover w-full h-full rounded-lg" />
                </div>
              </div>
              <div class="px-2">
                <div class="item" data-img="/showcase-1.top.jpg">
                  <img src="/showcase-1.top.jpg" alt="top" class="object-cover w-full h-full rounded-lg" />
                </div>
              </div>
            </div>
            <div class="preview">
        ...
        <div class="flex-1 px-4 md:p-6">
          ...
          <a href="cart.html" class="transition-all duration-200 bg-pink-400 text-black focus:bg-black focus:text-pink-400 rounded-full px-8 py-3 mt-4 inline-flex">
          ...
          <p class="text-xl leading-7">Providing a subtle nod to the past, Jetty also provides a perfect solution for the way we work today. A comprehensive product family, Jetty features a variety of elegant chairs and sofas.</p>
        </div>
      </div>
    </section>
  );
