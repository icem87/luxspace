      ...
      <div class="container mx-auto">
        ...
        <div class="flex overflow-x-auto mb-4 -mx-3">
          <div class="px-3 flex-none" style={{ width: "320px" }}>
            <div class="rounded-xl p-4 pb-8 relative bg-white">
              <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                <img src="/chair-1.png" alt="" class="w-full h-full object-cover object-center" />
              </div>
          ...
          <div class="px-3 flex-none" style={{ width: "320px" }}>
            <div class="rounded-xl p-4 pb-8 relative bg-white">
              <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                <img src="/chair-2.png" alt="" class="w-full h-full object-cover object-center" />
              </div>
          ...
          <div class="px-3 flex-none" style={{ width: "320px" }}>
            <div class="rounded-xl p-4 pb-8 relative bg-white">
              <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                <img src="/chair-3.png" alt="" class="w-full h-full object-cover object-center" />
              </div>
